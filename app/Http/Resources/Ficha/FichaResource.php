...
namespace App\Http\Resources\Ficha;
...
class FichaResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'responsavel_doc' => $this->responsavel_doc,
            'responsavel' => $this->responsavel,
            'responsavel_id' => $this->responsavel_id,
            'responsavel_parentesco' => $this->responsavel_parentesco,
            'responsavel_parentesco_id' => $this->responsavel_parentesco_id,
